	...
	let benefits = [
		{
			...
			description: 'Self-taught developers are often more motivated and passionate about their work. I am no exception.'
		},
		{
			name: 'a product design & ux fanatic',
			description: 'Product design and UX are my passion. I love creating beautiful, intuitive, and functional user experiences.'
		},
		{
			name: 'an excellent communicator',
			description:
				'Communication is key to any successful project. I am a great communicator and will keep you updated every step of the way.'
		}
	];
</script>
...
<main class="flex flex-col flex-1 p-4">
	<section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
		<div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
			<h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
				Hi! I'm <span class="poppins text-violet-400">Nate</span> Szelag <br />Full Stack
				<span class="poppins text-violet-400">Developer</span>
			</h2>
			<p class="text-base sm:text-lg md:text-xl">
				My <span class="text-violet-400">favorite tech</span> includes Javascript, React, Svelte, Node, and MongoDB.
			</p>
			<a
	...
	<section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
		...
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
			<Step step={steps[0]}
				><p>
					Smoljames Store is a merchandising store created with <strong class="text-violet-400"
